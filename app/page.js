...
const Home = () => {
	...
	return (
		<div className="flex flex-col items-center p-5 max-w-full h-[100vh] bg-slate-200 bg-gradient-to-r from-cyan-200 to-green-300">
			{' '}
			<h1 className="font-bold text-2xl">
				WhatsApp <span className="text-green-500">Validator</span>
			</h1>
			<p className="text-gray-500">
				Don't know if a number is a WhatsApp number? WhatsApp validator
				is the right tool at your grip to validate numbers.
			</p>
			<div className="m-5">
				{status.status ? (
